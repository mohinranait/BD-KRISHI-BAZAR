...
@section('content')
    ...
    <div class="col-md-3">
       ...
       <div class="col-lg-9">
            <form action="{{route('frontend.shop.update', $shop->id)}}" method="POST" enctype="multipart/form-data">
                @csrf 
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shop_name" value="{{$shop->shop_name}}" class="form-control" placeholder="Shop nmae">
                                    @error('shop_name')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shop_phone" value="{{$shop->shop_phone}}" class="form-control" placeholder="Shop phone">
                                            @error('shop_phone')
                                                <span class="text-danger">{{ $message }}<spanp>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="shop_email" value="{{$shop->shop_email}}" class="form-control" placeholder="Shop email">
                                            @error('shop_email')
                                                <span class="text-danger">{{ $message }}<spanp>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="shop_district_id" class="form-control" id="shopZila">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="shop_upzila_id" class="form-control" id="shopUpZila">
            ...
            if(zilaId){
                $.ajax({
                    ...
                    success:function(data){
                        $("#shopUpZila").empty();
                        $('#shopUpZila').html('<option value="">Select your Upzila</option>');
                        $.each(data, function(key,value){
 
                            $("#shopUpZila").append('<option value="'+value.id+'">'+value.name+'</option>');
                        });
                    }
                });
            }else{
                $('#shopUpZila').html('<option value="">Select country first</option>');
            }
        });
    });
