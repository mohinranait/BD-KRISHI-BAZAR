        ...
        <div class="span12">
          ...
          <div class="row">
            <div class="span4">
              <a style="text-decoration: none;" href="#"><div style="padding: 4px; text-align: center; border-style: solid; border-color: black; border-radius: 5px; background-color: #ffbb00;" class="well-primary">
                <h2 style="color: black; text-align: center;">Get Text by WebElement</h2>
              </div>
              </a>
            </div>
            ...
            <div class="span4">
              <a style="text-decoration: none;" href="#"><div style="padding: 4px; text-align: center; border-style: solid; border-color: black; border-radius: 5px; background-color: #ffbb00;" class="well-primary">
                <h2 style="color: black; text-align: center;">Get Text by JavaScript</h2>
              </div>
              </a>
            </div>
            ...
            <div class="span4">
              <a style="text-decoration: none;" href="#"><div style="padding: 4px; text-align: center; border-style: solid; border-color: black; border-radius: 5px; background-color: #ffbb00;" class="well-primary">
                <h2 style="color: black; text-align: center;">Get Text by Corordinate</h2>
              </div>
              </a>
            </div>
          </div>
          ...
          <div class="row">
            <div class="span4">
              <a style="text-decoration: none;" href="#"><div style="padding: 4px; text-align: left; border-style: solid; border-color: black; border-radius: 5px; background-color: #333;" class="well-primary">
                 <h6 style="color: yellow; text-align: center;">.getText();</h6>
              </div>
              </a>
            </div>
          ...
          <div class="row">
            <div class="span4">
             ...
             <ol type="1">
                  <li><p style="color: white; text-align: left;">আমরা দেখবো কিভাবে পেজ থেকে Text নিতে হয়। </p></li>
                   <li><p style="color: white; text-align: left;">আমরা দেখবো কিভাবে পেজ থেকে Text নিতে হয়। </p></li>
                    <li><p style="color: white; text-align: left;">আমরা দেখবো কিভাবে পেজ থেকে Text নিতে হয়। </p></li>
