    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.newPostCreatePost') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" required placeholder="Post Title" autocomplete="title" autofocus>
                        ...
                        <div class="form-group row">
                          <!-- Author Name -->
                            ...
                            <div class="col-md-10">
                                <input id="author_name" type="input" class="form-control @error('author_name') is-invalid @enderror" name="author_name" value="{{ old('author_name') }}" required  placeholder="Author name">
                                @error('author_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
